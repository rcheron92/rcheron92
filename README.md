...
### 💫 About Me
🚀 Software/Cloud Engineer specializing in **test automation** & **DevOps**
☁️ Mastering Azure certifications | Cloud Architecture enthusiast
🇭🇹 Founder of **YNVPD** — community development & education in Haiti
🎙️ Host of **Mindset Konbatan** — motivation meets growth
...
| Project | Description |
|---|---|
| 🧠 **TiRide** | Haiti ride & delivery app — React Native + Jenkins + Expo |
| 🌍 **YNVPD Website** | Nonprofit site — [damemariesos.com](https://damemariesos.com) |
| ⚙️ **Bosch IMS Automation** | Robot Framework test suites for RT66, US1A, Keypads, POPEX |
| 🎙️ **Mindset Konbatan** | Motivational & educational podcast platform |

---

### 🎯 Current Focus
- ☁️ Azure AZ-900 → Cloud Architect path
- 💪 Fitness, consistency & leadership balance
- 🤖 Systematizing YNVPD ops through automation
